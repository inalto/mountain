...
class Report
{
    public static function import($o, $options)
    {
        ...
        $qry->leftJoin('field_data_field_lunghezza', function ($q) {
            $q->on('field_data_field_lunghezza.entity_id', '=', 'node.nid');
        });
        $qry->leftJoin('field_data_field_quota_di_partenza', function ($q) {
            $q->on('field_data_field_quota_di_partenza.entity_id', '=', 'node.nid');
        });
        $qry->leftJoin('field_data_field_altitudine', function ($q) {
            $q->on('field_data_field_altitudine.entity_id', '=', 'node.nid');
        });
        $qry->leftJoin('field_data_field_dislivello', function ($q) {
