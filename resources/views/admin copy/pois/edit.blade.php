...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.poi.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pois.update", [$poi->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.poi.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $poi->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lat') ? 'is-invalid' : '' }}" type="text" name="lat" id="lat" value="{{ old('lat', $poi->lat) }}">
                @if($errors->has('lat'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lon') ? 'is-invalid' : '' }}" type="text" name="lon" id="lon" value="{{ old('lon', $poi->lon) }}">
                @if($errors->has('lon'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('height') ? 'is-invalid' : '' }}" type="text" name="height" id="height" value="{{ old('height', $poi->height) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('access') ? 'is-invalid' : '' }}" name="access" id="access">{!! old('access', $poi->access) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $poi->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('bibliography') ? 'is-invalid' : '' }}" name="bibliography" id="bibliography">{{ old('bibliography', $poi->bibliography) }}</textarea>
