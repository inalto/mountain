<x-app-layout>
    ...
    <section class="report">
        ...
        <div class="rs body-font">
            ...
            <div class="rs body-font prose">
        
                <div class="border-t border-gray-200 dark:border-gray-600">
                    <dl>
                        @if ($report->difficulty)
                      <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 dark:bg-gray-800 dark:text-gray-100">
                      ...
                      <div class="border-t dark:border-gray-500 bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 dark:bg-gray-800 dark:text-gray-100">
                      ...
                      @if ($report->drop_p)
                      <div class="border-t bg-gray-50 dark:border-gray-500 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 dark:bg-gray-800 dark:text-gray-100">
