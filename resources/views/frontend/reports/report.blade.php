<x-app-layout>
  ...
  <section class="report">
    <x-slot name="header">
      ...
      <a href="{{route('admin.reports.edit',$report->id)}}">
        ...
        <h1 class="text-xl font-semibold leading-tight dark:text-white" alt=" {{ $report->nid }}">
    ...
    <div class="rs bg-white dark:bg-gray-800 dark:text-gray-200 body-font prose">
      ...
      <x-tags :tags="$report->tags"></x-tags>

      <div class="">
        <dl>
          @if ($report->difficulty)
          <div class="bg-gray-50  px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 dark:bg-gray-900 dark:text-gray-100">
            <dt class="text-sm font-medium text-gray-500 dark:text-gray-200">
              <svg class="inline-block w-6 h-6 mr-1 fill-current text-gray-600 dark:text-gray-200" stroke="currentColor" viewBox="0 0 24 24" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
          ...
          @if ($report->length)
          <div class="border-t border-dotted dark:border-gray-500 bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 dark:bg-gray-900 dark:text-gray-100">
            ...
            <dt class="text-sm font-medium text-gray-500 dark:text-gray-200">
              ...
              {{ trans('cruds.report.fields.length') }}
            </dt>
            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-200 sm:mt-0 sm:col-span-2">
              {{ $report->length }}&nbsp;Km
            </dd>
          ...
          <div class="border-t border-dotted dark:border-gray-500 bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 dark:bg-gray-900 dark:text-gray-100">
            ...
            <dt class="text-sm font-medium text-gray-500 dark:text-gray-200">
              <svg class="inline-block w-6 h-6 mr-1 fill-current text-gray-600 dark:text-gray-200" stroke="currentColor" viewBox="0 0 300 300" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
          ...
          @if ($report->drop_p)
          <div class="border-t border-dotted bg-gray-50 dark:border-gray-500 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 dark:bg-gray-900 dark:text-gray-100">
          ...
          <div class="border-t border-dotted bg-gray-50 dark:border-gray-500 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 dark:bg-gray-900 dark:text-gray-100">
            ...
            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-200 sm:mt-0 sm:col-span-2">
              {{ Carbon\Carbon::create($report->time_a)->format("H\hi'") }}
            </dd>

          </div>
          @endif

          @if ($report->time_r != "00:00")
          <div class="border-t border-dotted bg-gray-50 dark:border-gray-500 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 dark:bg-gray-900 dark:text-gray-100">
          ...
          <svg class="inline-block w-6 h-6 mr-1 fill-current text-gray-600 dark:text-gray-200" fill="currentColor"  viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
            <g transform="matrix(0.951342,0,0,0.914516,-0.885906,-0.696774)">
                <g id="Tavola-da-disegno11" serif:id="Tavola da disegno1">
                    <g transform="matrix(1.05115,0,0,1.09347,0.0591547,-0.0527048)">
                        <path d="M13.592,4.655L13.592,3.007C13.592,2.713 13.435,2.441 13.18,2.294C12.925,2.147 12.611,2.147 12.356,2.294C12.101,2.441 11.944,2.713 11.944,3.007L11.944,4.655C11.944,4.949 12.101,5.221 12.356,5.368C12.611,5.516 12.925,5.516 13.18,5.368C13.435,5.221 13.592,4.949 13.592,4.655Z" style="fill-rule:nonzero;"/>
                    </g>
                    <g transform="matrix(1.05115,0,0,1.09347,0.0591547,-0.0527048)">
                        <path d="M18.594,7.891C18.812,7.891 19.022,7.805 19.176,7.65L20.341,6.485C20.5,6.332 20.591,6.121 20.592,5.9C20.594,5.679 20.507,5.466 20.351,5.31C20.195,5.154 19.983,5.067 19.762,5.069C19.54,5.071 19.329,5.161 19.176,5.32L18.011,6.485C17.857,6.64 17.77,6.849 17.77,7.068C17.77,7.286 17.857,7.496 18.011,7.65C18.166,7.805 18.375,7.891 18.594,7.891Z" style="fill-rule:nonzero;"/>
                    </g>
                    <g transform="matrix(1.05115,0,0,1.09347,0.0591547,-0.0527048)">
                        <path d="M22.654,13.717C22.948,13.717 23.22,13.56 23.367,13.305C23.515,13.05 23.515,12.736 23.367,12.481C23.22,12.226 22.948,12.069 22.654,12.069L21.006,12.069C20.712,12.069 20.44,12.226 20.293,12.481C20.146,12.736 20.146,13.05 20.293,13.305C20.44,13.56 20.712,13.717 21.006,13.717L22.654,13.717Z" style="fill-rule:nonzero;"/>
                    </g>
                    <g transform="matrix(1.05115,0,0,1.09347,0.0591547,-0.0527048)">
                        <path d="M19.176,18.136C19.022,17.977 18.811,17.886 18.591,17.885C18.37,17.883 18.157,17.97 18.001,18.126C17.845,18.282 17.758,18.494 17.76,18.715C17.762,18.936 17.852,19.147 18.011,19.301L19.176,20.466C19.385,20.668 19.686,20.745 19.966,20.668C20.247,20.591 20.466,20.372 20.543,20.091C20.62,19.811 20.543,19.51 20.341,19.301L19.176,18.136Z" style="fill-rule:nonzero;"/>
                    </g>
                    <g transform="matrix(1.05115,0,0,1.09347,0.0591547,-0.0527048)">
                        <path d="M11.944,21.132L11.944,22.78C11.944,23.074 12.101,23.346 12.356,23.493C12.611,23.64 12.925,23.64 13.18,23.493C13.435,23.346 13.592,23.074 13.592,22.78L13.592,21.132C13.592,20.837 13.435,20.566 13.18,20.418C12.925,20.271 12.611,20.271 12.356,20.418C12.101,20.566 11.944,20.837 11.944,21.132Z" style="fill-rule:nonzero;"/>
                    </g>
                    <g transform="matrix(1.05115,0,0,1.09347,0.0591547,-0.0527048)">
                        <path d="M6.36,18.136L5.195,19.301C5.036,19.454 4.946,19.665 4.944,19.886C4.942,20.107 5.029,20.32 5.185,20.476C5.341,20.632 5.554,20.719 5.775,20.717C5.996,20.715 6.207,20.625 6.36,20.466L7.525,19.301C7.684,19.147 7.775,18.936 7.777,18.715C7.779,18.494 7.692,18.282 7.535,18.126C7.379,17.97 7.167,17.883 6.946,17.885C6.725,17.886 6.514,17.977 6.36,18.136Z" style="fill-rule:nonzero;"/>
                    </g>
                    <g transform="matrix(1.05115,0,0,1.09347,0.0591547,-0.0527048)">
                        <path d="M2.882,13.717L4.53,13.717C4.824,13.717 5.096,13.56 5.243,13.305C5.39,13.05 5.39,12.736 5.243,12.481C5.096,12.226 4.824,12.069 4.53,12.069L2.882,12.069C2.588,12.069 2.316,12.226 2.169,12.481C2.021,12.736 2.021,13.05 2.169,13.305C2.316,13.56 2.588,13.717 2.882,13.717Z" style="fill-rule:nonzero;"/>
                    </g>
                    <g transform="matrix(1.05115,0,0,1.09347,0.0591547,-0.0527048)">
                        <path d="M7.525,7.65C7.68,7.496 7.767,7.286 7.767,7.068C7.767,6.85 7.68,6.64 7.525,6.486L6.36,5.321C6.151,5.119 5.851,5.042 5.57,5.119C5.29,5.196 5.071,5.415 4.994,5.695C4.917,5.976 4.994,6.276 5.196,6.485L6.36,7.65C6.515,7.805 6.724,7.892 6.943,7.892C7.161,7.892 7.371,7.805 7.525,7.65Z" style="fill-rule:nonzero;"/>
                    </g>
                    <g transform="matrix(1.05115,0,0,1.09347,0.0591547,-0.0527048)">
                        <path d="M12.768,6.303C10.414,6.303 8.238,7.559 7.061,9.598C5.883,11.637 5.883,14.15 7.061,16.189C8.238,18.228 10.414,19.484 12.768,19.484C14.626,19.48 16.397,18.693 17.645,17.317C17.957,16.97 18.233,16.592 18.469,16.189C18.769,15.672 18.999,15.118 19.153,14.541C19.219,14.277 19.268,13.997 19.309,13.717C19.375,13.17 19.375,12.616 19.309,12.069C19.268,11.789 19.219,11.509 19.153,11.245C18.999,10.668 18.769,10.114 18.469,9.598C18.233,9.195 17.957,8.817 17.645,8.469C16.397,7.093 14.626,6.306 12.768,6.302L12.768,6.303ZM15.487,17.013L13.592,17.013L13.592,16.189L16.443,16.189C16.162,16.504 15.84,16.781 15.487,17.013ZM17.423,14.541L13.592,14.541L13.592,13.717L17.637,13.717C17.596,13.999 17.524,14.275 17.423,14.541ZM17.637,12.069L13.592,12.07L13.592,11.246L17.423,11.246C17.524,11.512 17.596,11.788 17.637,12.07L17.637,12.069ZM13.592,9.598L13.592,8.774L15.487,8.774C15.84,9.006 16.162,9.283 16.443,9.598L13.592,9.598Z" style="fill-rule:nonzero;"/>
                    </g>
                </g>
            </g>
        </svg>

        {{ trans('cruds.report.fields.exposure') }}
            </dt>
            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-200 sm:mt-0 sm:col-span-2">
              {{ $report->exposure }}
            </dd>
    ...
    <x-report.bibliographies :bibliographies="$report->bibliographies"></x-report.bibliographies>


  </section>
  <section class="rs bg-transparent">
    <x-report.gallery :photos="$report->photos" :date="$report->created_at->format('Y')" :author="$report->owner->first_name.' '.$report->owner->last_name">
      </x-report.galley>
  </section>


  <section>
    <x-maps :tracks="$report->tracks"></x-maps>
  </section>
  ...
  <section class="rs havebeenthere prose-xl">
    ...
    <div class="card">
      ...
      <div class="card-body">
      <livewire:frontend.have-been-there :report_id="$report->id">
