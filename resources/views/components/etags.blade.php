<div wire:ignore  class="w-full">
    ...
    <select class="w-full form-control" data-minimum-results-for-search="Infinity" data-placeholder="{{ __('Select your option') }}" {{ $attributes->only('wire:model') }} multiple=true tags=true data-allow-clear="false" > 
