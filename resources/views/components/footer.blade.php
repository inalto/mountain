<footer class="py-10 lg:py-20">
  <div class="container mx-auto px-4 mb-12 md:mb-20">
    <div class="max-w-2xl mx-auto text-center">
      <a class="inline-block mb-8 text-gray-900 text-lg font-semibold" href="#">
        <img class="h-24" src="/theme/logo.png" alt="" width="auto">
      </a>
      <ul class="mb-8 flex flex-wrap space-x-8 items-center justify-center text-sm">
        <li class="mb-2 md:mb-0"><a class="font-medium hover:text-gray-600 dark:text-gray-200 dark:hover:text-white" href="#">About</a></li>
        <li class="mb-2 md:mb-0"><a class="font-medium hover:text-gray-600 dark:text-gray-200 dark:hover:text-white" href="#">Company</a></li>
        <li class="mb-2 md:mb-0"><a class="font-medium hover:text-gray-600 dark:text-gray-200 dark:hover:text-white" href="#">Services</a></li>
        <li class="mb-2 md:mb-0"><a class="font-medium hover:text-gray-600 dark:text-gray-200 dark:hover:text-white" href="#">Testimonials</a></li>
      </ul>
      <div class="flex justify-center">
        <a class="flex justify-center items-center w-10 h-10 mr-4 bg-gray-50 hover:bg-white dark:bg-gray-850 dark:hover:bg-gray-800  rounded-full" href="#">
        ...
        <a class="flex justify-center items-center w-10 h-10 bg-gray-50 hover:bg-white dark:bg-gray-850 dark:hover:bg-gray-800 rounded-full" href="#">
  ...
  <p class="text-center text-sm text-gray-500 pt-8 px-4 border-t border-gray-200 dark:border-gray-800 ">
Copyright © 2000-<?php echo date('Y');?> Martini Multimedia s.a.s. - p.iva 01099890079
</p>
</footer>