<form wire:submit.prevent="submit" class="p-3">
    ...
    <div class="form-group {{ $errors->has('report.title') ? 'invalid' : '' }}">
        ...
        <x-jet-input class="form-control" type="text" name="title" id="title" required wire:model.defer="report.title">
    ...
    <div class="form-group {{ $errors->has('report.slug') ? 'invalid' : '' }}">
        ...
        <x-jet-input class="form-control" type="text" name="slug" id="slug" wire:model.defer="report.slug">
        <div class="validation-message">
