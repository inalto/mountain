            ...
            <table class="table table-index w-full">
                ...
                <tbody>
                    ...
                    <tr class="table-row">
                        ...
                        <td>
                            <a href="javascript:void(0)" wire:click.prevent="toggle('approved',{{$hbt->id}})"> <x-input.toggle :checked="$hbt->approved" /></a>
                        </td>
                        <td>
                            <a href="javascript:void(0)" wire:click.prevent="toggle('published',{{$hbt->id}})"> <x-input.toggle :checked="$hbt->published" /></a>
                        </td>
                        <td>
                            {{ $hbt->difficulty }}
                        </td>
