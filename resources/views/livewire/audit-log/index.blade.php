<div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    @can('audit_log_show')
                                        <a class="show mr-2" href="{{ route('admin.audit-logs.show', $auditLog) }}">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                    ...
                                    @endcan
                                    @can('audit_log_edit')
                                        <a class="edit mr-2" href="{{ route('admin.audit-logs.edit', $auditLog) }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    ...
                                    @endcan
                                    @can('audit_log_delete')
                                        <button class="delete mr-2" type="button" wire:click="confirm('delete', {{ $auditLog->id }})" wire:loading.attr="disabled">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
