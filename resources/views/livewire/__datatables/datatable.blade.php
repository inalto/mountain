<div>
    ...
    <div class="relative">
        <div class="flex items-center justify-between mb-1">
            <div class="flex items-center flex-grow h-10">
                ...
                <div class="flex rounded-lg shadow-sm w-96">
                    <div class="relative flex-grow focus-within:z-10">
                        ...
                        <input wire:model.debounce.500ms="search" class="block w-full py-2 pl-10 transition duration-150 ease-in-out bg-white rounded-md dark:br-gray-900 dark:border-gray-800 form-input focus:bg-white sm:text-sm sm:leading-5" placeholder="Search in {{ $this->searchableColumns()->map->label->join(', ') }}" />
            ...
            <div class="flex items-center space-x-1">
                ...
                <div x-data="{ init() {
                    ...
                    <button wire:click="export" class="flex items-center px-3 space-x-2 text-xs font-medium leading-4 tracking-wider text-green-500 uppercase bg-white border border-green-400 rounded-md dark:br-gray-900 dark:border-gray-800 hover:bg-green-200 focus:outline-none"><span>Export</span>
        ...
        <div class="overflow-auto bg-white rounded-lg shadow-lg dark:bg-gray-900 max-w-screen">
            <div class="rounded-lg @unless($this->hidePagination) rounded-b-none @endif">
                <div class="table min-w-full align-middle">
                    ...
                    @forelse($this->results as $result)
                        <div class="table-row p-1 divide-x divide-gray-100 dark:divide-gray-900 {{ isset($result->checkbox_attribute) && in_array($result->checkbox_attribute, $selected) ? 'bg-orange-100' : ($loop->even ? 'bg-gray-100 dark:bg-gray-800' : 'bg-gray-50 dark:bg-gray-700') }}">
            ...
            <div class="bg-white border-b border-gray-200 rounded-lg rounded-t-none dark:bg-gray-800 dark:bg-opacity-50 dark:border-gray-900 max-w-screen">
