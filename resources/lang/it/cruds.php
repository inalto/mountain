...
return [
    ...
    "category" => [
        "fields" => [
            ...
            "created_at_helper" => "Data di creazione",
            "deleted_at" => "Cancellato il",
            "deleted_at_helper" => "Data di cancellazione",
            "description" => "Descrizione",
            "description_helper" => "Descrizione della categoria",
            "id" => "ID",
            "id_helper" => "ID univoco",
            "name" => "Nome",
            "name_helper" => "Nome della categoria",
            "slug" => "Slug",
            "slug_helper" => "Url alias",
            "updated_at" => "Aggiornato il",
            "updated_at_helper" => "Data dell'ultimo aggiornamento"
        ],
        "title" => "Categorie",
    ...
    "havebeenthere" => [
        "fields" => [
            "content" => "Il mio resoconto",
            "content_helper" => "Contenuto",
            "date" => "Data",
            "date_helper" => "Data ci sono stato",
            "difficulty" => "Difficoltà",
            "id" => "ID",
            "owner" => "Proprietario",
            "owner_helper" => "Proprietario del ci sono stato",
            "owner_id" => "Id proprietario",
            "owner_id_helper" => "Identificativo del proprietario",
            "report" => "Relazione",
            "report_helper" => "Relazione a cui è  riferito",
            "report_id" => "Id Relazione",
            "report_id_helper" => "Identificativo della relazione",
            "slug" => "Url alias",
            "slug_helper" => "Url alias",
            "title" => "In breve",
            "title_helper" => "L'escursione in una riga",
            "username" => "Nome utente"
        ],
        "title" => "Ci sono stato",
        "title_singular" => "Ci sono stato"
    ],
    ...
    "newsCategory" => [
        "fields" => [
            "created_at" => "Creato il",
            "created_at_helper" => "Creato it",
            "deleted_at" => "Cancellato il",
            "deleted_at_helper" => "",
            "description" => "Descrizione",
            "description_helper" => "Inserisci una descrizione",
            "id" => "ID",
            "id_helper" => "",
            "name" => "Nome",
            "name_helper" => "Nome della categoria",
            "slug" => "Slug",
            "slug_helper" => "Url alias univoco",
            "title" => "Title",
            "title_helper" => "",
            "updated_at" => "Updated at",
            "updated_at_helper" => ""
    ...
    "report" => [
        "fields" => [
            ...
            "id_helper" => "",
            "intro" => "Introduzione",
            "last_survey" => "Ultimo rilievo",
            "last_survey_helper" => "Data dell'ultimo rilievo",
            "length" => "Lunghezza",
