...
return [
    ...
    "category" => [
        "fields" => [
            "created_at" => "Créé le",
            "created_at_helper" => "Date de création",
            "deleted_at" => "Supprimé le",
            "deleted_at_helper" => "Date de l'annulation",
            "description" => "Description",
            "description_helper" => "Description de la catégorie",
            "id" => "Id",
            "id_helper" => "ID unique",
            "name" => "Nom",
            "name_helper" => "Nom de la catégorie",
            "slug" => "Limace",
            "slug_helper" => "Alias d'URL",
            "updated_at" => "Mis à jour le",
            "updated_at_helper" => "Date de la dernière mise à jour "
        ],
        "title" => "Categories",
    ...
    "report" => [
        "fields" => [
            ...
            "id_helper" => " ",
            "intro" => "Introduction",
            "last_survey" => "Dernière enquête",
            "last_survey_helper" => "Date de la dernière enquête",
            "length" => "Longueur",
